...
| sft-qtypes-bitext/bitext-support | bitext/Bitext-customer-support-llm-chatbot-training-dataset `default/train/*.parquet` | `f93dfd84` | CDLA-Sharing-1.0 | synthetic (by Bitext; varied phrasing, typos, colloquial) | 2026-09-25 | supervised fine-tuning (Phase 5c, D-037); 15% held out for the question-type dev set, never trained on | 26,872 → 2,123 | 98,440 | 19,127 | — | Bitext customer-support messages (not its replies), D-037 label map, no template slots |
| sft-qtypes-bitext/bitext-banking | bitext/Bitext-retail-banking-llm-chatbot-training-dataset `*.parquet` | `3e362109` | CDLA-Sharing-1.0 | synthetic (by Bitext; varied phrasing, typos, colloquial) | 2026-09-25 | supervised fine-tuning (Phase 5c, D-037); 15% held out for the question-type dev set, never trained on | 25,545 → 3,000 | 159,175 | 33,858 | — | Bitext retail-banking messages (not its replies), D-037 label map |
| sft-qtypes-bitext/bitext-telco | bitext/Bitext-telco-llm-chatbot-training-dataset `default/train/*.parquet` | `45588345` | CDLA-Sharing-1.0 | synthetic (by Bitext; varied phrasing, typos, colloquial) | 2026-09-25 | supervised fine-tuning (Phase 5c, D-037); 15% held out for the question-type dev set, never trained on | 26,000 → 1,800 | 98,924 | 19,953 | — | Bitext telco messages (not its replies), D-037 label map |
| sft-qtypes-massive/massive-en-train | AmazonScience/massive `en-US/train/*.parquet` | `ed58ac42` | CC-BY-4.0 | real (crowdsourced) | 2026-09-25 | supervised fine-tuning (Phase 5c, D-037); 15% held out for the question-type dev set, never trained on | 11,514 → 1,122 | 36,492 | 7,218 | — | English everyday assistant requests (MASSIVE en-US train), D-037 |
| sft-qtypes-massive/massive-ar-train | AmazonScience/massive `ar-SA/train/*.parquet` | `ed58ac42` | CC-BY-4.0 | real (localized by native speakers) | 2026-09-25 | supervised fine-tuning (Phase 5c, D-037); 15% held out for the question-type dev set, never trained on | 11,514 → 613 | 27,584 | 3,019 | — | Arabic everyday assistant requests (MASSIVE ar-SA train), D-037 |
| sft-qtypes-bitext | teacher: Qwen3.5-35B-A3B UD-Q4_K_XL (unsloth/Qwen3.5-35B-A3B-GGUF) via llama.cpp; new replies for data/sft/sft-qtypes-bitext/train_candidates.jsonl | `bc014a17` | Apache-2.0 (teacher outputs) | synthetic | 2026-09-25 | supervised fine-tuning (Phase 5) | 2,877 → 2,839 | 492,973 | 92,123 | — | 288 requests; varieties english; before judge verification |
| sft-qtypes-massive | teacher: Qwen3.5-35B-A3B UD-Q4_K_XL (unsloth/Qwen3.5-35B-A3B-GGUF) via llama.cpp; new replies for data/sft/sft-qtypes-massive/train_candidates.jsonl | `bc014a17` | Apache-2.0 (teacher outputs) | synthetic | 2026-09-25 | supervised fine-tuning (Phase 5) | 1,193 → 1,181 | 179,578 | 26,803 | — | 121 requests; varieties english, saudi_arabic; before judge verification |
| sft-qtypes-gen | teacher: Qwen3.5-35B-A3B UD-Q4_K_XL (unsloth/Qwen3.5-35B-A3B-GGUF) via llama.cpp | `bc014a17` | Apache-2.0 (teacher outputs) | synthetic | 2026-09-25 | supervised fine-tuning (Phase 5) | 9,923 → 5,305 | 1,082,800 | 110,877 | — | 1248 requests, 502,748 teacher tokens; before judge verification |
| sft-qtypes-gen2 | teacher: Qwen3.5-35B-A3B UD-Q4_K_XL (unsloth/Qwen3.5-35B-A3B-GGUF) via llama.cpp | `bc014a17` | Apache-2.0 (teacher outputs) | synthetic | 2026-09-25 | supervised fine-tuning (Phase 5) | 5,788 → 3,087 | 591,296 | 62,862 | — | 728 requests, 283,892 teacher tokens; before judge verification |
